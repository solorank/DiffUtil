...
public class DiffCallBack extends DiffUtil.Callback {
    private List<JavaBean> mOldDatas, mNewDatas;//看名字

    public DiffCallBack(List<JavaBean> mOldDatas, List<JavaBean> mNewDatas) {
    ...
    public boolean areContentsTheSame(int oldItemPosition, int newItemPosition) {
        JavaBean beanOld = mOldDatas.get(oldItemPosition);
        JavaBean beanNew = mNewDatas.get(newItemPosition);
    ...
    public Object getChangePayload(int oldItemPosition, int newItemPosition) {
        ...
        JavaBean oldBean = mOldDatas.get(oldItemPosition);
        JavaBean newBean = mNewDatas.get(newItemPosition);
